...
This contract is mandatory for every Sills audit report. It keeps specialist reports comparable while allowing domain-specific conclusions.
...
- `shipDecision`: required and set to `ready-to-ship`, `ready-with-conditions`, `not-ready`, or `insufficient-evidence`.
...
- Audit-specific dimensions documented by the active specialist skills
