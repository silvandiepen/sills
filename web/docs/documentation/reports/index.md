...
For concrete output shape and language, read the [example reports](/documentation/examples).

Start with [status conclusions and tasks](/documentation/reports/status-and-tasks) to understand the shared health scale and remediation queue.
