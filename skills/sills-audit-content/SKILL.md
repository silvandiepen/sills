...
description: Audit the full content experience of a product, including product comprehension, information architecture, navigation labels, UX writing, grammar, terminology, onboarding, states, marketing-to-product consistency, documentation coherence, localisation, and evidence-based AI-slop indicators. Use when reviewing whether a product is clear, concise, credible, coherent, and understandable.
license: MIT
metadata:
...
Use finding IDs `CNT-0001`, `CNT-0002`, and so on.
