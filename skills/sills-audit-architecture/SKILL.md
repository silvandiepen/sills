...
Before writing any Codebase architecture audit output, read `references/report-contract.md` and use the bundled report template.
...
Recommended status dimensions: Repository structure; Component and module boundaries; Services and integrations; State and data flow; Maintainability.
