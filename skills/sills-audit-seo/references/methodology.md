...
- Crawlable and indexable public information architecture
- Consistent canonical, redirect, status, and sitemap signals
- Accurate metadata and valid structured data
- Useful, unique content aligned with real search intent and product behaviour
