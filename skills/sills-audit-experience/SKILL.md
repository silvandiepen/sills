---
name: sills-audit-experience
description: Audit the visual design, usability, interaction quality, responsiveness, perceived performance, runtime behaviour, and product coherence of a website or application. Use for full UI/UX reviews, interaction testing, lag and jank investigation, responsive checks, design-system consistency, documentation alignment, positive-pattern identification, and evidence-based AI-slop assessment.
license: MIT
metadata:
...
Use finding IDs `EXP-0001`, `EXP-0002`, and so on.
...
Before writing any Product experience audit output, read `references/report-contract.md` and use the bundled report template.
...
Recommended status dimensions: Visual hierarchy; Interaction quality; Usability; Responsiveness; Perceived performance.
