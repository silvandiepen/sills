...
Before writing any Design system audit output, read `references/report-contract.md` and use the bundled report template.
...
Recommended status dimensions: Tokens; Components and states; Accessibility contracts; Adoption and consistency; Governance.
