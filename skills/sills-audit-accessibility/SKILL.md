---
name: sills-audit-accessibility
description: Audit an entire website, web application, or supported iOS application for accessibility barriers using source inspection, runtime evidence, automated checks, and explicit manual-review queues. Use for WCAG 2.2 A/AA audits, keyboard and focus testing, screen-reader behaviour, reflow, contrast, forms, motion, touch targets, Dynamic Type, VoiceOver, and inclusive-design reviews.
license: MIT
metadata:
...
Use finding IDs `A11Y-0001`, `A11Y-0002`, and so on.
...
Before writing any Accessibility audit output, read `references/report-contract.md` and use the bundled report template.
...
Recommended status dimensions: Critical journeys; Keyboard and focus; Screen-reader semantics; Visual and responsive access; Forms and errors.
