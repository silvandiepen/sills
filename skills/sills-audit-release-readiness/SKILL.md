---
name: sills-audit-release-readiness
description: Audit whether a project, application, change set, or release candidate is ready to ship using evidence from product behaviour, tests, CI/CD, migrations, observability, documentation, operations, support, rollback, security, privacy, accessibility, and known risks. Use before launches, production deployments, app-store submissions, migrations, or high-risk rollouts.
license: MIT
metadata:
...
- Specialist report: `reports/release-readiness.md`
- Finding IDs: `READY-0001`, `READY-0002`, and so on.
...
Before writing any Release readiness audit output, read `references/report-contract.md` and use the bundled report template.
...
Recommended status dimensions: Product; Quality; Operations; Data and migrations; Support and ownership.
